            ...
            while (logLine != null) {
                ...
                if (event instanceof BlockingEvent) {
                    ...
                    if (preprocessedEvent != null
                        ...
                        if (jvmDao.getUnidentifiedLogLines().size() < GarbageCat.REJECT_LIMIT) {
                ...
                List<LogEventType> eventTypes = jvmDao.getEventTypes();
                LogEventType eventType = JdkUtil.determineEventType(event.getName());
                ...
                if (event instanceof GcEvent) {
                    List<CollectorFamily> collectorFamilies = jvmDao.getCollectorFamilies();
